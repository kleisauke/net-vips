    ...
    <div class="row">
      <div class="col-md-8 col-md-offset-2 text-center">
        ...
        <section>
          ...
          <p class="lead">As well as the usual JPEG, JPEG 2000, JPEG XL, TIFF, PNG, Ultra HDR, WebP, HEIC, AVIF, PDF, SVG and GIF, it supports many scientific and technical image formats, including RAW, SVS, MRXS, OpenEXR, FITS, Matlab, NIfTI, Analyze, and PFM.
