...
namespace NetVips
{
    ...
    public partial class Image
    {
        ...
        /// <param name="operationBlock">Block an operation (and any subclasses) from running.</param>
        /// <param name="operationUnblock">Unblock an operation (and any subclasses) from running.</param>
        ...
        public static void Configure(bool? untrustedBlock = null, string operationBlock = null, string operationUnblock = null, int? concurrency = null, ulong? pipeReadLimit = null, int? cacheMax = null, ulong? cacheMaxMem = null, int? cacheMaxFiles = null)
        {
            ...
            options.AddIfPresent("untrusted_block", untrustedBlock);
            options.AddIfPresent("operation_block", operationBlock);
            options.AddIfPresent("operation_unblock", operationUnblock);
            options.AddIfPresent(nameof(concurrency), concurrency);
            options.AddIfPresent("pipe_read_limit", pipeReadLimit);
            options.AddIfPresent("cache_max", cacheMax);
            options.AddIfPresent("cache_max_mem", cacheMaxMem);
            options.AddIfPresent("cache_max_files", cacheMaxFiles);

            Operation.Call("configure", options);
        }
        ...
        /// <example>
        /// <code language="lang-csharp">
        /// in.Gifsave(filename, dither: double, effort: int, bitdepth: int, maxerror: double, strip: bool, background: double[], pageHeight: int);
        /// </code>
        /// </example>
        /// <param name="filename">Filename to save to.</param>
        ...
        /// <param name="maxerror">Maximum inter-frame error for transparency.</param>
        /// <param name="strip">Strip all metadata from image.</param>
        /// <param name="background">Background value.</param>
        /// <param name="pageHeight">Set page height for multipage save.</param>
        public void Gifsave(string filename, double? dither = null, int? effort = null, int? bitdepth = null, double? maxerror = null, bool? strip = null, double[] background = null, int? pageHeight = null)
        {
            var options = new VOption();
            ...
            options.AddIfPresent(nameof(maxerror), maxerror);
            options.AddIfPresent(nameof(strip), strip);
            options.AddIfPresent(nameof(background), background);
            options.AddIfPresent("page_height", pageHeight);
        ...
        /// <example>
        /// <code language="lang-csharp">
        /// byte[] buffer = in.GifsaveBuffer(dither: double, effort: int, bitdepth: int, maxerror: double, strip: bool, background: double[], pageHeight: int);
        /// </code>
        /// </example>
        /// <param name="dither">Amount of dithering.</param>
        /// <param name="effort">Quantisation effort.</param>
        ...
        /// <param name="pageHeight">Set page height for multipage save.</param>
        /// <returns>An array of bytes.</returns>
        public byte[] GifsaveBuffer(double? dither = null, int? effort = null, int? bitdepth = null, double? maxerror = null, bool? strip = null, double[] background = null, int? pageHeight = null)
        {
            var options = new VOption();
        ...
        /// <example>
        /// <code language="lang-csharp">
        /// in.GifsaveTarget(target, dither: double, effort: int, bitdepth: int, maxerror: double, strip: bool, background: double[], pageHeight: int);
        /// </code>
        /// </example>
        /// <param name="target">Target to save to.</param>
        /// <param name="dither">Amount of dithering.</param>
        ...
        /// <param name="background">Background value.</param>
        /// <param name="pageHeight">Set page height for multipage save.</param>
        public void GifsaveTarget(Target target, double? dither = null, int? effort = null, int? bitdepth = null, double? maxerror = null, bool? strip = null, double[] background = null, int? pageHeight = null)
        {
            var options = new VOption();
        ...
        /// <example>
        /// <code language="lang-csharp">
        /// in.GifsaveStream(stream, dither: double, effort: int, bitdepth: int, maxerror: double, strip: bool, background: double[], pageHeight: int);
        /// </code>
        /// </example>
        /// <param name="stream">Stream to save to.</param>
        /// <param name="dither">Amount of dithering.</param>
        ...
        /// <param name="background">Background value.</param>
        /// <param name="pageHeight">Set page height for multipage save.</param>
        public void GifsaveStream(Stream stream, double? dither = null, int? effort = null, int? bitdepth = null, double? maxerror = null, bool? strip = null, double[] background = null, int? pageHeight = null)
        {
            using var target = TargetStream.NewFromStream(stream);
            GifsaveTarget(target, dither, effort, bitdepth, maxerror, strip, background, pageHeight);
        }
        ...
        /// <example>
        /// <code language="lang-csharp">
        /// in.Heifsave(filename, q: int, bitdepth: int, lossless: bool, compression: Enums.ForeignHeifCompression, effort: int, subsampleMode: Enums.ForeignSubsample, strip: bool, background: double[], pageHeight: int);
        /// </code>
        /// </example>
        /// <param name="filename">Filename to save to.</param>
        ...
        /// <param name="background">Background value.</param>
        /// <param name="pageHeight">Set page height for multipage save.</param>
        public void Heifsave(string filename, int? q = null, int? bitdepth = null, bool? lossless = null, Enums.ForeignHeifCompression? compression = null, int? effort = null, Enums.ForeignSubsample? subsampleMode = null, bool? strip = null, double[] background = null, int? pageHeight = null)
        {
            var options = new VOption();
        ...
        /// <example>
        /// <code language="lang-csharp">
        /// byte[] buffer = in.HeifsaveBuffer(q: int, bitdepth: int, lossless: bool, compression: Enums.ForeignHeifCompression, effort: int, subsampleMode: Enums.ForeignSubsample, strip: bool, background: double[], pageHeight: int);
        /// </code>
        /// </example>
        /// <param name="q">Q factor.</param>
        /// <param name="bitdepth">Number of bits per pixel.</param>
        ...
        /// <param name="pageHeight">Set page height for multipage save.</param>
        /// <returns>An array of bytes.</returns>
        public byte[] HeifsaveBuffer(int? q = null, int? bitdepth = null, bool? lossless = null, Enums.ForeignHeifCompression? compression = null, int? effort = null, Enums.ForeignSubsample? subsampleMode = null, bool? strip = null, double[] background = null, int? pageHeight = null)
        {
            var options = new VOption();
        ...
        /// <example>
        /// <code language="lang-csharp">
        /// in.HeifsaveTarget(target, q: int, bitdepth: int, lossless: bool, compression: Enums.ForeignHeifCompression, effort: int, subsampleMode: Enums.ForeignSubsample, strip: bool, background: double[], pageHeight: int);
        /// </code>
        /// </example>
        /// <param name="target">Target to save to.</param>
        /// <param name="q">Q factor.</param>
        ...
        /// <param name="background">Background value.</param>
        /// <param name="pageHeight">Set page height for multipage save.</param>
        public void HeifsaveTarget(Target target, int? q = null, int? bitdepth = null, bool? lossless = null, Enums.ForeignHeifCompression? compression = null, int? effort = null, Enums.ForeignSubsample? subsampleMode = null, bool? strip = null, double[] background = null, int? pageHeight = null)
        {
            var options = new VOption();
        ...
        /// <example>
        /// <code language="lang-csharp">
        /// in.HeifsaveStream(stream, q: int, bitdepth: int, lossless: bool, compression: Enums.ForeignHeifCompression, effort: int, subsampleMode: Enums.ForeignSubsample, strip: bool, background: double[], pageHeight: int);
        /// </code>
        /// </example>
        /// <param name="stream">Stream to save to.</param>
        /// <param name="q">Q factor.</param>
        ...
        /// <param name="background">Background value.</param>
        /// <param name="pageHeight">Set page height for multipage save.</param>
        public void HeifsaveStream(Stream stream, int? q = null, int? bitdepth = null, bool? lossless = null, Enums.ForeignHeifCompression? compression = null, int? effort = null, Enums.ForeignSubsample? subsampleMode = null, bool? strip = null, double[] background = null, int? pageHeight = null)
        {
            using var target = TargetStream.NewFromStream(stream);
            HeifsaveTarget(target, q, bitdepth, lossless, compression, effort, subsampleMode, strip, background, pageHeight);
        }
        ...
        /// <param name="background">Background value.</param>
        /// <param name="password">Decrypt with this password.</param>
        /// <param name="memory">Force open via memory.</param>
        /// <param name="access">Required access pattern for this file.</param>
        /// <param name="failOn">Error level to fail on.</param>
        /// <returns>A new <see cref="Image"/>.</returns>
