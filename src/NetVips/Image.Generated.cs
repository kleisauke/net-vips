...
public partial class Image
{
    ...
    /// <example>
    /// <code language="lang-csharp">
    /// using Image @out = NetVips.Image.Uhdrload(filename, hdr: bool, shrink: int, memory: bool, access: Enums.Access, failOn: Enums.FailOn, revalidate: bool);
    /// </code>
    /// </example>
    /// <param name="filename">Filename to load from.</param>
    /// <param name="hdr">decode to scRGB.</param>
    /// <param name="shrink">Shrink factor on load.</param>
    /// <param name="memory">Force open via memory.</param>
    /// <param name="access">Required access pattern for this file.</param>
    /// <param name="failOn">Error level to fail on.</param>
    /// <param name="revalidate">Don't use a cached result for this operation.</param>
    /// <returns>A new <see cref="Image"/>.</returns>
    public static Image Uhdrload(string filename, bool? hdr = null, int? shrink = null, bool? memory = null, Enums.Access? access = null, Enums.FailOn? failOn = null, bool? revalidate = null)
    {
        var options = new VOption();

        options.AddIfPresent(nameof(hdr), hdr);
        options.AddIfPresent(nameof(shrink), shrink);
        options.AddIfPresent(nameof(memory), memory);
        options.AddIfPresent(nameof(access), access);
        options.AddFailOn(failOn);
    ...
    /// <example>
    /// <code language="lang-csharp">
    /// using Image @out = NetVips.Image.Uhdrload(filename, out var flags, hdr: bool, shrink: int, memory: bool, access: Enums.Access, failOn: Enums.FailOn, revalidate: bool);
    /// </code>
    /// </example>
    /// <param name="filename">Filename to load from.</param>
    /// <param name="flags">Flags for this file.</param>
    ...
    /// <param name="revalidate">Don't use a cached result for this operation.</param>
    /// <returns>A new <see cref="Image"/>.</returns>
    public static Image Uhdrload(string filename, out Enums.ForeignFlags flags, bool? hdr = null, int? shrink = null, bool? memory = null, Enums.Access? access = null, Enums.FailOn? failOn = null, bool? revalidate = null)
    {
        var options = new VOption();
    ...
    /// <example>
    /// <code language="lang-csharp">
    /// using Image @out = NetVips.Image.UhdrloadBuffer(buffer, hdr: bool, shrink: int, memory: bool, access: Enums.Access, failOn: Enums.FailOn);
    /// </code>
    /// </example>
    /// <param name="buffer">Buffer to load from.</param>
    /// <param name="hdr">decode to scRGB.</param>
    ...
    /// <param name="failOn">Error level to fail on.</param>
    /// <returns>A new <see cref="Image"/>.</returns>
    public static Image UhdrloadBuffer(byte[] buffer, bool? hdr = null, int? shrink = null, bool? memory = null, Enums.Access? access = null, Enums.FailOn? failOn = null)
    {
        var options = new VOption();
    ...
    /// <example>
    /// <code language="lang-csharp">
    /// using Image @out = NetVips.Image.UhdrloadBuffer(buffer, out var flags, hdr: bool, shrink: int, memory: bool, access: Enums.Access, failOn: Enums.FailOn);
    /// </code>
    /// </example>
    /// <param name="buffer">Buffer to load from.</param>
    /// <param name="flags">Flags for this file.</param>
    ...
    /// <param name="failOn">Error level to fail on.</param>
    /// <returns>A new <see cref="Image"/>.</returns>
    public static Image UhdrloadBuffer(byte[] buffer, out Enums.ForeignFlags flags, bool? hdr = null, int? shrink = null, bool? memory = null, Enums.Access? access = null, Enums.FailOn? failOn = null)
    {
        var options = new VOption();
    ...
    /// <example>
    /// <code language="lang-csharp">
    /// using Image @out = NetVips.Image.UhdrloadSource(source, hdr: bool, shrink: int, memory: bool, access: Enums.Access, failOn: Enums.FailOn);
    /// </code>
    /// </example>
    /// <param name="source">Source to load from.</param>
    /// <param name="hdr">decode to scRGB.</param>
    ...
    /// <param name="failOn">Error level to fail on.</param>
    /// <returns>A new <see cref="Image"/>.</returns>
    public static Image UhdrloadSource(Source source, bool? hdr = null, int? shrink = null, bool? memory = null, Enums.Access? access = null, Enums.FailOn? failOn = null)
    {
        var options = new VOption();
    ...
    /// <example>
    /// <code language="lang-csharp">
    /// using Image @out = NetVips.Image.UhdrloadStream(stream, hdr: bool, shrink: int, memory: bool, access: Enums.Access, failOn: Enums.FailOn);
    /// </code>
    /// </example>
    /// <param name="stream">Stream to load from.</param>
    /// <param name="hdr">decode to scRGB.</param>
    ...
    /// <param name="failOn">Error level to fail on.</param>
    /// <returns>A new <see cref="Image"/>.</returns>
    public static Image UhdrloadStream(Stream stream, bool? hdr = null, int? shrink = null, bool? memory = null, Enums.Access? access = null, Enums.FailOn? failOn = null)
    {
        var source = SourceStream.NewFromStream(stream);
        var image = UhdrloadSource(source, hdr, shrink, memory, access, failOn);
    ...
    /// <example>
    /// <code language="lang-csharp">
    /// using Image @out = NetVips.Image.UhdrloadSource(source, out var flags, hdr: bool, shrink: int, memory: bool, access: Enums.Access, failOn: Enums.FailOn);
    /// </code>
    /// </example>
    /// <param name="source">Source to load from.</param>
    /// <param name="flags">Flags for this file.</param>
    ...
    /// <param name="failOn">Error level to fail on.</param>
    /// <returns>A new <see cref="Image"/>.</returns>
    public static Image UhdrloadSource(Source source, out Enums.ForeignFlags flags, bool? hdr = null, int? shrink = null, bool? memory = null, Enums.Access? access = null, Enums.FailOn? failOn = null)
    {
        var options = new VOption();
    ...
    /// <example>
    /// <code language="lang-csharp">
    /// using Image @out = NetVips.Image.UhdrloadStream(stream, out var flags, hdr: bool, shrink: int, memory: bool, access: Enums.Access, failOn: Enums.FailOn);
    /// </code>
    /// </example>
    /// <param name="stream">Stream to load from.</param>
    /// <param name="flags">Flags for this file.</param>
    ...
    /// <param name="failOn">Error level to fail on.</param>
    /// <returns>A new <see cref="Image"/>.</returns>
    public static Image UhdrloadStream(Stream stream, out Enums.ForeignFlags flags, bool? hdr = null, int? shrink = null, bool? memory = null, Enums.Access? access = null, Enums.FailOn? failOn = null)
    {
        var source = SourceStream.NewFromStream(stream);
        var image = UhdrloadSource(source, out flags, hdr, shrink, memory, access, failOn);
