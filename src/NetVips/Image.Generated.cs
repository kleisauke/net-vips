...
public partial class Image
{
    ...
    /// <example>
    /// <code language="lang-csharp">
    /// using Image @out = NetVips.Image.Dcrawload(filename, bitdepth: int, memory: bool, access: Enums.Access, failOn: Enums.FailOn, revalidate: bool);
    /// </code>
    /// </example>
    /// <param name="filename">Filename to load from.</param>
    ...
    /// <param name="revalidate">Don't use a cached result for this operation.</param>
    /// <returns>A new <see cref="Image"/>.</returns>
    public static Image Dcrawload(string filename, int? bitdepth = null, bool? memory = null, Enums.Access? access = null, Enums.FailOn? failOn = null, bool? revalidate = null)
    {
        var options = new VOption();
        ...
        return Operation.Call("dcrawload", options, filename) as Image;
    }
    ...
    /// <example>
    /// <code language="lang-csharp">
    /// using Image @out = NetVips.Image.Dcrawload(filename, out var flags, bitdepth: int, memory: bool, access: Enums.Access, failOn: Enums.FailOn, revalidate: bool);
    /// </code>
    /// </example>
    /// <param name="filename">Filename to load from.</param>
    /// <param name="flags">Flags for this file.</param>
    ...
    /// <param name="revalidate">Don't use a cached result for this operation.</param>
    /// <returns>A new <see cref="Image"/>.</returns>
    public static Image Dcrawload(string filename, out Enums.ForeignFlags flags, int? bitdepth = null, bool? memory = null, Enums.Access? access = null, Enums.FailOn? failOn = null, bool? revalidate = null)
    {
        var options = new VOption();
        ...
        var results = Operation.Call("dcrawload", options, filename) as object[];
        var finalResult = results?[0] as Image;
        var opts = results?[1] as VOption;
        flags = (Enums.ForeignFlags)opts?["flags"];
    ...
    /// <example>
    /// <code language="lang-csharp">
    /// using Image @out = NetVips.Image.DcrawloadBuffer(buffer, bitdepth: int, memory: bool, access: Enums.Access, failOn: Enums.FailOn);
    /// </code>
    /// </example>
    ...
    /// <param name="failOn">Error level to fail on.</param>
    /// <returns>A new <see cref="Image"/>.</returns>
    public static Image DcrawloadBuffer(byte[] buffer, int? bitdepth = null, bool? memory = null, Enums.Access? access = null, Enums.FailOn? failOn = null)
    {
        var options = new VOption();
        ...
        return Operation.Call("dcrawload_buffer", options, buffer) as Image;
    }
    ...
    /// <example>
    /// <code language="lang-csharp">
    /// using Image @out = NetVips.Image.DcrawloadBuffer(buffer, out var flags, bitdepth: int, memory: bool, access: Enums.Access, failOn: Enums.FailOn);
    /// </code>
    /// </example>
    /// <param name="buffer">Buffer to load from.</param>
    /// <param name="flags">Flags for this file.</param>
    ...
    /// <param name="failOn">Error level to fail on.</param>
    /// <returns>A new <see cref="Image"/>.</returns>
    public static Image DcrawloadBuffer(byte[] buffer, out Enums.ForeignFlags flags, int? bitdepth = null, bool? memory = null, Enums.Access? access = null, Enums.FailOn? failOn = null)
    {
        var options = new VOption();
        ...
        var results = Operation.Call("dcrawload_buffer", options, buffer) as object[];
        var finalResult = results?[0] as Image;
        var opts = results?[1] as VOption;
        flags = (Enums.ForeignFlags)opts?["flags"];
    ...
    /// <example>
    /// <code language="lang-csharp">
    /// using Image @out = NetVips.Image.DcrawloadSource(source, bitdepth: int, memory: bool, access: Enums.Access, failOn: Enums.FailOn);
    /// </code>
    /// </example>
    /// <param name="source">Source to load from.</param>
    /// <param name="bitdepth">Number of bits per pixel.</param>
    ...
    /// <param name="failOn">Error level to fail on.</param>
    /// <returns>A new <see cref="Image"/>.</returns>
    public static Image DcrawloadSource(Source source, int? bitdepth = null, bool? memory = null, Enums.Access? access = null, Enums.FailOn? failOn = null)
    {
        var options = new VOption();
        ...
        return Operation.Call("dcrawload_source", options, source) as Image;
    }
    ...
    /// <example>
    /// <code language="lang-csharp">
    /// using Image @out = NetVips.Image.DcrawloadStream(stream, bitdepth: int, memory: bool, access: Enums.Access, failOn: Enums.FailOn);
    /// </code>
    /// </example>
    /// <param name="stream">Stream to load from.</param>
    /// <param name="bitdepth">Number of bits per pixel.</param>
    ...
    /// <param name="failOn">Error level to fail on.</param>
    /// <returns>A new <see cref="Image"/>.</returns>
    public static Image DcrawloadStream(Stream stream, int? bitdepth = null, bool? memory = null, Enums.Access? access = null, Enums.FailOn? failOn = null)
    {
        var source = SourceStream.NewFromStream(stream);
        var image = DcrawloadSource(source, bitdepth, memory, access, failOn);
    ...
    /// <example>
    /// <code language="lang-csharp">
    /// using Image @out = NetVips.Image.DcrawloadSource(source, out var flags, bitdepth: int, memory: bool, access: Enums.Access, failOn: Enums.FailOn);
    /// </code>
    /// </example>
    /// <param name="source">Source to load from.</param>
    /// <param name="flags">Flags for this file.</param>
    ...
    /// <param name="failOn">Error level to fail on.</param>
    /// <returns>A new <see cref="Image"/>.</returns>
    public static Image DcrawloadSource(Source source, out Enums.ForeignFlags flags, int? bitdepth = null, bool? memory = null, Enums.Access? access = null, Enums.FailOn? failOn = null)
    {
        var options = new VOption();
        ...
        var results = Operation.Call("dcrawload_source", options, source) as object[];
        var finalResult = results?[0] as Image;
        var opts = results?[1] as VOption;
        flags = (Enums.ForeignFlags)opts?["flags"];
    ...
    /// <example>
    /// <code language="lang-csharp">
    /// using Image @out = NetVips.Image.DcrawloadStream(stream, out var flags, bitdepth: int, memory: bool, access: Enums.Access, failOn: Enums.FailOn);
    /// </code>
    /// </example>
    /// <param name="stream">Stream to load from.</param>
    /// <param name="flags">Flags for this file.</param>
    ...
    /// <param name="failOn">Error level to fail on.</param>
    /// <returns>A new <see cref="Image"/>.</returns>
    public static Image DcrawloadStream(Stream stream, out Enums.ForeignFlags flags, int? bitdepth = null, bool? memory = null, Enums.Access? access = null, Enums.FailOn? failOn = null)
    {
        var source = SourceStream.NewFromStream(stream);
        var image = DcrawloadSource(source, out flags, bitdepth, memory, access, failOn);
    ...
    /// <example>
    /// <code language="lang-csharp">
    /// in.Heifsave(filename, q: int, bitdepth: int, lossless: bool, compression: Enums.ForeignHeifCompression, effort: int, subsampleMode: Enums.ForeignSubsample, encoder: Enums.ForeignHeifEncoder, tune: string, keep: Enums.ForeignKeep, background: double[], pageHeight: int, profile: string);
    /// </code>
    /// </example>
    /// <param name="filename">Filename to save to.</param>
    /// <param name="q">Q factor.</param>
    ...
    /// <param name="tune">Tuning parameters.</param>
    /// <param name="keep">Which metadata to retain.</param>
    /// <param name="background">Background value.</param>
    /// <param name="pageHeight">Set page height for multipage save.</param>
    /// <param name="profile">Filename of ICC profile to embed.</param>
    public void Heifsave(string filename, int? q = null, int? bitdepth = null, bool? lossless = null, Enums.ForeignHeifCompression? compression = null, int? effort = null, Enums.ForeignSubsample? subsampleMode = null, Enums.ForeignHeifEncoder? encoder = null, string tune = null, Enums.ForeignKeep? keep = null, double[] background = null, int? pageHeight = null, string profile = null)
    {
        var options = new VOption();
        ...
        options.AddIfPresent(nameof(tune), tune);
        options.AddForeignKeep(keep);
        options.AddIfPresent(nameof(background), background);
        options.AddIfPresent("page_height", pageHeight);
        options.AddIfPresent(nameof(profile), profile);
    ...
    /// <example>
    /// <code language="lang-csharp">
    /// byte[] buffer = in.HeifsaveBuffer(q: int, bitdepth: int, lossless: bool, compression: Enums.ForeignHeifCompression, effort: int, subsampleMode: Enums.ForeignSubsample, encoder: Enums.ForeignHeifEncoder, tune: string, keep: Enums.ForeignKeep, background: double[], pageHeight: int, profile: string);
    /// </code>
    /// </example>
    /// <param name="q">Q factor.</param>
    /// <param name="bitdepth">Number of bits per pixel.</param>
    ...
    /// <example>
    /// <code language="lang-csharp">
    /// in.HeifsaveTarget(target, q: int, bitdepth: int, lossless: bool, compression: Enums.ForeignHeifCompression, effort: int, subsampleMode: Enums.ForeignSubsample, encoder: Enums.ForeignHeifEncoder, tune: string, keep: Enums.ForeignKeep, background: double[], pageHeight: int, profile: string);
    /// </code>
    /// </example>
    /// <param name="target">Target to save to.</param>
    /// <param name="q">Q factor.</param>
    ...
    /// <example>
    /// <code language="lang-csharp">
    /// in.HeifsaveStream(stream, q: int, bitdepth: int, lossless: bool, compression: Enums.ForeignHeifCompression, effort: int, subsampleMode: Enums.ForeignSubsample, encoder: Enums.ForeignHeifEncoder, tune: string, keep: Enums.ForeignKeep, background: double[], pageHeight: int, profile: string);
    /// </code>
    /// </example>
    /// <param name="stream">Stream to save to.</param>
    /// <param name="q">Q factor.</param>
    ...
    {
        using var target = TargetStream.NewFromStream(stream);
        HeifsaveTarget(target, q, bitdepth, lossless, compression, effort, subsampleMode, encoder, tune, keep, background, pageHeight, profile);
    }
    ...
    /// <example>
    /// <code language="lang-csharp">
    /// in.Jxlsave(filename, tier: int, distance: double, effort: int, lossless: bool, q: int, bitdepth: int, keep: Enums.ForeignKeep, background: double[], pageHeight: int, profile: string);
    /// </code>
    /// </example>
    /// <param name="filename">Filename to save to.</param>
    ...
    /// <param name="pageHeight">Set page height for multipage save.</param>
    /// <param name="profile">Filename of ICC profile to embed.</param>
    public void Jxlsave(string filename, int? tier = null, double? distance = null, int? effort = null, bool? lossless = null, int? q = null, int? bitdepth = null, Enums.ForeignKeep? keep = null, double[] background = null, int? pageHeight = null, string profile = null)
    {
        var options = new VOption();
    ...
    /// <example>
    /// <code language="lang-csharp">
    /// byte[] buffer = in.JxlsaveBuffer(tier: int, distance: double, effort: int, lossless: bool, q: int, bitdepth: int, keep: Enums.ForeignKeep, background: double[], pageHeight: int, profile: string);
    /// </code>
    /// </example>
    /// <param name="tier">Decode speed tier.</param>
    /// <param name="distance">Target butteraugli distance.</param>
    ...
    /// <param name="profile">Filename of ICC profile to embed.</param>
    /// <returns>An array of bytes.</returns>
    public byte[] JxlsaveBuffer(int? tier = null, double? distance = null, int? effort = null, bool? lossless = null, int? q = null, int? bitdepth = null, Enums.ForeignKeep? keep = null, double[] background = null, int? pageHeight = null, string profile = null)
    {
        var options = new VOption();
    ...
    /// <example>
    /// <code language="lang-csharp">
    /// in.JxlsaveTarget(target, tier: int, distance: double, effort: int, lossless: bool, q: int, bitdepth: int, keep: Enums.ForeignKeep, background: double[], pageHeight: int, profile: string);
    /// </code>
    /// </example>
    /// <param name="target">Target to save to.</param>
    /// <param name="tier">Decode speed tier.</param>
    ...
    /// <param name="pageHeight">Set page height for multipage save.</param>
    /// <param name="profile">Filename of ICC profile to embed.</param>
    public void JxlsaveTarget(Target target, int? tier = null, double? distance = null, int? effort = null, bool? lossless = null, int? q = null, int? bitdepth = null, Enums.ForeignKeep? keep = null, double[] background = null, int? pageHeight = null, string profile = null)
    {
        var options = new VOption();
    ...
    /// <example>
    /// <code language="lang-csharp">
    /// in.JxlsaveStream(stream, tier: int, distance: double, effort: int, lossless: bool, q: int, bitdepth: int, keep: Enums.ForeignKeep, background: double[], pageHeight: int, profile: string);
    /// </code>
    /// </example>
    /// <param name="stream">Stream to save to.</param>
    /// <param name="tier">Decode speed tier.</param>
    ...
    /// <param name="pageHeight">Set page height for multipage save.</param>
    /// <param name="profile">Filename of ICC profile to embed.</param>
    public void JxlsaveStream(Stream stream, int? tier = null, double? distance = null, int? effort = null, bool? lossless = null, int? q = null, int? bitdepth = null, Enums.ForeignKeep? keep = null, double[] background = null, int? pageHeight = null, string profile = null)
    {
        using var target = TargetStream.NewFromStream(stream);
        JxlsaveTarget(target, tier, distance, effort, lossless, q, bitdepth, keep, background, pageHeight, profile);
    }
    ...
    /// <example>
    /// <code language="lang-csharp">
    /// using Image @out = NetVips.Image.MagickloadSource(source, density: string, page: int, n: int, memory: bool, access: Enums.Access, failOn: Enums.FailOn);
    /// </code>
    /// </example>
    /// <param name="source">Source to load from.</param>
    /// <param name="density">Canvas resolution for rendering vector formats like SVG.</param>
    ...
    /// <param name="failOn">Error level to fail on.</param>
    /// <returns>A new <see cref="Image"/>.</returns>
    public static Image MagickloadSource(Source source, string density = null, int? page = null, int? n = null, bool? memory = null, Enums.Access? access = null, Enums.FailOn? failOn = null)
    {
        var options = new VOption();
        ...
        return Operation.Call("magickload_source", options, source) as Image;
    }

    /// <summary>
    /// Load stream with ImageMagick.
    /// </summary>
    /// <example>
    /// <code language="lang-csharp">
    /// using Image @out = NetVips.Image.MagickloadStream(stream, density: string, page: int, n: int, memory: bool, access: Enums.Access, failOn: Enums.FailOn);
    /// </code>
    /// </example>
    /// <param name="stream">Stream to load from.</param>
    /// <param name="density">Canvas resolution for rendering vector formats like SVG.</param>
    ...
    /// <param name="failOn">Error level to fail on.</param>
    /// <returns>A new <see cref="Image"/>.</returns>
    public static Image MagickloadStream(Stream stream, string density = null, int? page = null, int? n = null, bool? memory = null, Enums.Access? access = null, Enums.FailOn? failOn = null)
    {
        var source = SourceStream.NewFromStream(stream);
        var image = MagickloadSource(source, density, page, n, memory, access, failOn);
    ...
    /// <example>
    /// <code language="lang-csharp">
    /// using Image @out = NetVips.Image.MagickloadSource(source, out var flags, density: string, page: int, n: int, memory: bool, access: Enums.Access, failOn: Enums.FailOn);
    /// </code>
    /// </example>
    /// <param name="source">Source to load from.</param>
    /// <param name="flags">Flags for this file.</param>
    ...
    /// <param name="failOn">Error level to fail on.</param>
    /// <returns>A new <see cref="Image"/>.</returns>
    public static Image MagickloadSource(Source source, out Enums.ForeignFlags flags, string density = null, int? page = null, int? n = null, bool? memory = null, Enums.Access? access = null, Enums.FailOn? failOn = null)
    {
        var options = new VOption();
        ...
        var results = Operation.Call("magickload_source", options, source) as object[];
        var finalResult = results?[0] as Image;
        var opts = results?[1] as VOption;
        flags = (Enums.ForeignFlags)opts?["flags"];
    ...
    /// <example>
    /// <code language="lang-csharp">
    /// using Image @out = NetVips.Image.MagickloadStream(stream, out var flags, density: string, page: int, n: int, memory: bool, access: Enums.Access, failOn: Enums.FailOn);
    /// </code>
    /// </example>
    /// <param name="stream">Stream to load from.</param>
    /// <param name="flags">Flags for this file.</param>
    ...
    /// <param name="failOn">Error level to fail on.</param>
    /// <returns>A new <see cref="Image"/>.</returns>
    public static Image MagickloadStream(Stream stream, out Enums.ForeignFlags flags, string density = null, int? page = null, int? n = null, bool? memory = null, Enums.Access? access = null, Enums.FailOn? failOn = null)
    {
        var source = SourceStream.NewFromStream(stream);
        var image = MagickloadSource(source, out flags, density, page, n, memory, access, failOn);
    ...
    /// <example>
    /// <code language="lang-csharp">
    /// using Image @out = in.Oklab2Oklch();
    /// </code>
    /// </example>
    /// <returns>A new <see cref="Image"/>.</returns>
    public Image Oklab2Oklch()
    {
        return this.Call("Oklab2Oklch") as Image;
    }
    ...
    /// <example>
    /// <code language="lang-csharp">
    /// using Image @out = in.Oklab2XYZ();
    /// </code>
    /// </example>
    /// <returns>A new <see cref="Image"/>.</returns>
    public Image Oklab2XYZ()
    {
        return this.Call("Oklab2XYZ") as Image;
    }
    ...
    /// <example>
    /// <code language="lang-csharp">
    /// using Image @out = in.Oklch2Oklab();
    /// </code>
    /// </example>
    /// <returns>A new <see cref="Image"/>.</returns>
    public Image Oklch2Oklab()
    {
        return this.Call("Oklch2Oklab") as Image;
    }
    ...
    /// <example>
    /// <code language="lang-csharp">
    /// using Image @out = NetVips.Image.Pdfload(filename, page: int, n: int, dpi: double, scale: double, background: double[], password: string, pageBox: Enums.ForeignPdfPageBox, memory: bool, access: Enums.Access, failOn: Enums.FailOn, revalidate: bool);
    /// </code>
    /// </example>
    /// <param name="filename">Filename to load from.</param>
    /// <param name="page">First page to load.</param>
    ...
    /// <param name="pageBox">The region of the page to render.</param>
    /// <param name="memory">Force open via memory.</param>
    /// <param name="access">Required access pattern for this file.</param>
    /// <param name="failOn">Error level to fail on.</param>
    /// <param name="revalidate">Don't use a cached result for this operation.</param>
    /// <returns>A new <see cref="Image"/>.</returns>
    public static Image Pdfload(string filename, int? page = null, int? n = null, double? dpi = null, double? scale = null, double[] background = null, string password = null, Enums.ForeignPdfPageBox? pageBox = null, bool? memory = null, Enums.Access? access = null, Enums.FailOn? failOn = null, bool? revalidate = null)
    {
        var options = new VOption();
        ...
        options.AddIfPresent("page_box", pageBox);
        options.AddIfPresent(nameof(memory), memory);
        options.AddIfPresent(nameof(access), access);
        options.AddFailOn(failOn);
        options.AddIfPresent(nameof(revalidate), revalidate);
    ...
    /// <example>
    /// <code language="lang-csharp">
    /// using Image @out = NetVips.Image.Pdfload(filename, out var flags, page: int, n: int, dpi: double, scale: double, background: double[], password: string, pageBox: Enums.ForeignPdfPageBox, memory: bool, access: Enums.Access, failOn: Enums.FailOn, revalidate: bool);
    /// </code>
    /// </example>
    /// <param name="filename">Filename to load from.</param>
    /// <param name="flags">Flags for this file.</param>
    ...
    /// <param name="revalidate">Don't use a cached result for this operation.</param>
    /// <returns>A new <see cref="Image"/>.</returns>
    public static Image Pdfload(string filename, out Enums.ForeignFlags flags, int? page = null, int? n = null, double? dpi = null, double? scale = null, double[] background = null, string password = null, Enums.ForeignPdfPageBox? pageBox = null, bool? memory = null, Enums.Access? access = null, Enums.FailOn? failOn = null, bool? revalidate = null)
    {
        var options = new VOption();
    ...
    /// <example>
    /// <code language="lang-csharp">
    /// using Image @out = NetVips.Image.PdfloadBuffer(buffer, page: int, n: int, dpi: double, scale: double, background: double[], password: string, pageBox: Enums.ForeignPdfPageBox, memory: bool, access: Enums.Access, failOn: Enums.FailOn);
    /// </code>
    /// </example>
    /// <param name="buffer">Buffer to load from.</param>
    /// <param name="page">First page to load.</param>
    ...
    /// <param name="failOn">Error level to fail on.</param>
    /// <returns>A new <see cref="Image"/>.</returns>
    public static Image PdfloadBuffer(byte[] buffer, int? page = null, int? n = null, double? dpi = null, double? scale = null, double[] background = null, string password = null, Enums.ForeignPdfPageBox? pageBox = null, bool? memory = null, Enums.Access? access = null, Enums.FailOn? failOn = null)
    {
        var options = new VOption();
    ...
    /// <example>
    /// <code language="lang-csharp">
    /// using Image @out = NetVips.Image.PdfloadBuffer(buffer, out var flags, page: int, n: int, dpi: double, scale: double, background: double[], password: string, pageBox: Enums.ForeignPdfPageBox, memory: bool, access: Enums.Access, failOn: Enums.FailOn);
    /// </code>
    /// </example>
    /// <param name="buffer">Buffer to load from.</param>
    /// <param name="flags">Flags for this file.</param>
    ...
    /// <param name="failOn">Error level to fail on.</param>
    /// <returns>A new <see cref="Image"/>.</returns>
    public static Image PdfloadBuffer(byte[] buffer, out Enums.ForeignFlags flags, int? page = null, int? n = null, double? dpi = null, double? scale = null, double[] background = null, string password = null, Enums.ForeignPdfPageBox? pageBox = null, bool? memory = null, Enums.Access? access = null, Enums.FailOn? failOn = null)
    {
        var options = new VOption();
    ...
    /// <example>
    /// <code language="lang-csharp">
    /// using Image @out = NetVips.Image.PdfloadSource(source, page: int, n: int, dpi: double, scale: double, background: double[], password: string, pageBox: Enums.ForeignPdfPageBox, memory: bool, access: Enums.Access, failOn: Enums.FailOn);
    /// </code>
    /// </example>
    /// <param name="source">Source to load from.</param>
    /// <param name="page">First page to load.</param>
    ...
    /// <param name="failOn">Error level to fail on.</param>
    /// <returns>A new <see cref="Image"/>.</returns>
    public static Image PdfloadSource(Source source, int? page = null, int? n = null, double? dpi = null, double? scale = null, double[] background = null, string password = null, Enums.ForeignPdfPageBox? pageBox = null, bool? memory = null, Enums.Access? access = null, Enums.FailOn? failOn = null)
    {
        var options = new VOption();
    ...
    /// <example>
    /// <code language="lang-csharp">
    /// using Image @out = NetVips.Image.PdfloadStream(stream, page: int, n: int, dpi: double, scale: double, background: double[], password: string, pageBox: Enums.ForeignPdfPageBox, memory: bool, access: Enums.Access, failOn: Enums.FailOn);
    /// </code>
    /// </example>
    /// <param name="stream">Stream to load from.</param>
    /// <param name="page">First page to load.</param>
    ...
    /// <param name="failOn">Error level to fail on.</param>
    /// <returns>A new <see cref="Image"/>.</returns>
    public static Image PdfloadStream(Stream stream, int? page = null, int? n = null, double? dpi = null, double? scale = null, double[] background = null, string password = null, Enums.ForeignPdfPageBox? pageBox = null, bool? memory = null, Enums.Access? access = null, Enums.FailOn? failOn = null)
    {
        var source = SourceStream.NewFromStream(stream);
        var image = PdfloadSource(source, page, n, dpi, scale, background, password, pageBox, memory, access, failOn);
    ...
    /// <example>
    /// <code language="lang-csharp">
    /// using Image @out = NetVips.Image.PdfloadSource(source, out var flags, page: int, n: int, dpi: double, scale: double, background: double[], password: string, pageBox: Enums.ForeignPdfPageBox, memory: bool, access: Enums.Access, failOn: Enums.FailOn);
    /// </code>
    /// </example>
    /// <param name="source">Source to load from.</param>
    /// <param name="flags">Flags for this file.</param>
    ...
    /// <param name="failOn">Error level to fail on.</param>
    /// <returns>A new <see cref="Image"/>.</returns>
    public static Image PdfloadSource(Source source, out Enums.ForeignFlags flags, int? page = null, int? n = null, double? dpi = null, double? scale = null, double[] background = null, string password = null, Enums.ForeignPdfPageBox? pageBox = null, bool? memory = null, Enums.Access? access = null, Enums.FailOn? failOn = null)
    {
        var options = new VOption();
    ...
    /// <example>
    /// <code language="lang-csharp">
    /// using Image @out = NetVips.Image.PdfloadStream(stream, out var flags, page: int, n: int, dpi: double, scale: double, background: double[], password: string, pageBox: Enums.ForeignPdfPageBox, memory: bool, access: Enums.Access, failOn: Enums.FailOn);
    /// </code>
    /// </example>
    /// <param name="stream">Stream to load from.</param>
    /// <param name="flags">Flags for this file.</param>
    ...
    /// <param name="failOn">Error level to fail on.</param>
    /// <returns>A new <see cref="Image"/>.</returns>
    public static Image PdfloadStream(Stream stream, out Enums.ForeignFlags flags, int? page = null, int? n = null, double? dpi = null, double? scale = null, double[] background = null, string password = null, Enums.ForeignPdfPageBox? pageBox = null, bool? memory = null, Enums.Access? access = null, Enums.FailOn? failOn = null)
    {
        var source = SourceStream.NewFromStream(stream);
        var image = PdfloadSource(source, out flags, page, n, dpi, scale, background, password, pageBox, memory, access, failOn);
    ...
    /// <example>
    /// <code language="lang-csharp">
    /// NetVips.Image.System(cmdFormat, @in: Image[], inFormat: string, outFormat: string, cache: bool);
    /// </code>
    /// </example>
    ...
    /// <param name="cache">Cache this call.</param>
    public static void System(string cmdFormat, Image[] @in = null, string inFormat = null, string outFormat = null, bool? cache = null)
    {
        var options = new VOption();
        ...
        options.AddIfPresent(nameof(cache), cache);
    ...
    /// <example>
    /// <code language="lang-csharp">
    /// NetVips.Image.System(cmdFormat, out var @out, @in: Image[], inFormat: string, outFormat: string, cache: bool);
    /// </code>
    /// </example>
    /// <param name="cmdFormat">Command to run.</param>
    ...
    /// <param name="outFormat">Format for output filename.</param>
    /// <param name="cache">Cache this call.</param>
    public static void System(string cmdFormat, out Image @out, Image[] @in = null, string inFormat = null, string outFormat = null, bool? cache = null)
    {
        var options = new VOption();
    ...
    /// <example>
    /// <code language="lang-csharp">
    /// NetVips.Image.System(cmdFormat, out var @out, out var log, @in: Image[], inFormat: string, outFormat: string, cache: bool);
    /// </code>
    /// </example>
    /// <param name="cmdFormat">Command to run.</param>
    /// <param name="out">Output image.</param>
    ...
    /// <param name="outFormat">Format for output filename.</param>
    /// <param name="cache">Cache this call.</param>
    public static void System(string cmdFormat, out Image @out, out string log, Image[] @in = null, string inFormat = null, string outFormat = null, bool? cache = null)
    {
        var options = new VOption();
    ...
    /// <example>
    /// <code language="lang-csharp">
    /// using Image @out = in.Uhdr2scRGB();
    /// </code>
    /// </example>
    /// <returns>A new <see cref="Image"/>.</returns>
    public Image Uhdr2scRGB()
    {
        return this.Call("uhdr2scRGB") as Image;
    }
    ...
    /// <example>
    /// <code language="lang-csharp">
    /// using Image @out = NetVips.Image.Uhdrload(filename, shrink: int, memory: bool, access: Enums.Access, failOn: Enums.FailOn, revalidate: bool);
    /// </code>
    /// </example>
    /// <param name="filename">Filename to load from.</param>
    /// <param name="shrink">Shrink factor on load.</param>
    ...
    /// <param name="revalidate">Don't use a cached result for this operation.</param>
    /// <returns>A new <see cref="Image"/>.</returns>
    public static Image Uhdrload(string filename, int? shrink = null, bool? memory = null, Enums.Access? access = null, Enums.FailOn? failOn = null, bool? revalidate = null)
    {
        var options = new VOption();
        ...
        return Operation.Call("uhdrload", options, filename) as Image;
    }
    ...
    /// <example>
    /// <code language="lang-csharp">
    /// using Image @out = NetVips.Image.Uhdrload(filename, out var flags, shrink: int, memory: bool, access: Enums.Access, failOn: Enums.FailOn, revalidate: bool);
    /// </code>
    /// </example>
    /// <param name="filename">Filename to load from.</param>
    /// <param name="flags">Flags for this file.</param>
    ...
    /// <param name="revalidate">Don't use a cached result for this operation.</param>
    /// <returns>A new <see cref="Image"/>.</returns>
    public static Image Uhdrload(string filename, out Enums.ForeignFlags flags, int? shrink = null, bool? memory = null, Enums.Access? access = null, Enums.FailOn? failOn = null, bool? revalidate = null)
    {
        var options = new VOption();
        ...
        var results = Operation.Call("uhdrload", options, filename) as object[];
        var finalResult = results?[0] as Image;
        var opts = results?[1] as VOption;
        flags = (Enums.ForeignFlags)opts?["flags"];
    ...
    /// <example>
    /// <code language="lang-csharp">
    /// using Image @out = NetVips.Image.UhdrloadBuffer(buffer, shrink: int, memory: bool, access: Enums.Access, failOn: Enums.FailOn);
    /// </code>
    /// </example>
    /// <param name="buffer">Buffer to load from.</param>
    /// <param name="shrink">Shrink factor on load.</param>
    ...
    /// <param name="failOn">Error level to fail on.</param>
    /// <returns>A new <see cref="Image"/>.</returns>
    public static Image UhdrloadBuffer(byte[] buffer, int? shrink = null, bool? memory = null, Enums.Access? access = null, Enums.FailOn? failOn = null)
    {
        var options = new VOption();
        ...
        return Operation.Call("uhdrload_buffer", options, buffer) as Image;
    }
    ...
    /// <example>
    /// <code language="lang-csharp">
    /// using Image @out = NetVips.Image.UhdrloadBuffer(buffer, out var flags, shrink: int, memory: bool, access: Enums.Access, failOn: Enums.FailOn);
    /// </code>
    /// </example>
    /// <param name="buffer">Buffer to load from.</param>
    /// <param name="flags">Flags for this file.</param>
    ...
    /// <param name="failOn">Error level to fail on.</param>
    /// <returns>A new <see cref="Image"/>.</returns>
    public static Image UhdrloadBuffer(byte[] buffer, out Enums.ForeignFlags flags, int? shrink = null, bool? memory = null, Enums.Access? access = null, Enums.FailOn? failOn = null)
    {
        var options = new VOption();
        ...
        var results = Operation.Call("uhdrload_buffer", options, buffer) as object[];
        var finalResult = results?[0] as Image;
        var opts = results?[1] as VOption;
        flags = (Enums.ForeignFlags)opts?["flags"];
    ...
    /// <example>
    /// <code language="lang-csharp">
    /// using Image @out = NetVips.Image.UhdrloadSource(source, shrink: int, memory: bool, access: Enums.Access, failOn: Enums.FailOn);
    /// </code>
    /// </example>
    /// <param name="source">Source to load from.</param>
    /// <param name="shrink">Shrink factor on load.</param>
    ...
    /// <param name="failOn">Error level to fail on.</param>
    /// <returns>A new <see cref="Image"/>.</returns>
    public static Image UhdrloadSource(Source source, int? shrink = null, bool? memory = null, Enums.Access? access = null, Enums.FailOn? failOn = null)
    {
        var options = new VOption();
        ...
        return Operation.Call("uhdrload_source", options, source) as Image;
    }
    ...
    /// <example>
    /// <code language="lang-csharp">
    /// using Image @out = NetVips.Image.UhdrloadStream(stream, shrink: int, memory: bool, access: Enums.Access, failOn: Enums.FailOn);
    /// </code>
    /// </example>
    /// <param name="stream">Stream to load from.</param>
    /// <param name="shrink">Shrink factor on load.</param>
    ...
    /// <param name="failOn">Error level to fail on.</param>
    /// <returns>A new <see cref="Image"/>.</returns>
    public static Image UhdrloadStream(Stream stream, int? shrink = null, bool? memory = null, Enums.Access? access = null, Enums.FailOn? failOn = null)
    {
        var source = SourceStream.NewFromStream(stream);
        var image = UhdrloadSource(source, shrink, memory, access, failOn);
    ...
    /// <example>
    /// <code language="lang-csharp">
    /// using Image @out = NetVips.Image.UhdrloadSource(source, out var flags, shrink: int, memory: bool, access: Enums.Access, failOn: Enums.FailOn);
    /// </code>
    /// </example>
    /// <param name="source">Source to load from.</param>
    /// <param name="flags">Flags for this file.</param>
    ...
    /// <param name="failOn">Error level to fail on.</param>
    /// <returns>A new <see cref="Image"/>.</returns>
    public static Image UhdrloadSource(Source source, out Enums.ForeignFlags flags, int? shrink = null, bool? memory = null, Enums.Access? access = null, Enums.FailOn? failOn = null)
    {
        var options = new VOption();
        ...
        var results = Operation.Call("uhdrload_source", options, source) as object[];
        var finalResult = results?[0] as Image;
        var opts = results?[1] as VOption;
        flags = (Enums.ForeignFlags)opts?["flags"];
    ...
    /// <example>
    /// <code language="lang-csharp">
    /// using Image @out = NetVips.Image.UhdrloadStream(stream, out var flags, shrink: int, memory: bool, access: Enums.Access, failOn: Enums.FailOn);
    /// </code>
    /// </example>
    /// <param name="stream">Stream to load from.</param>
    /// <param name="flags">Flags for this file.</param>
    ...
    /// <param name="failOn">Error level to fail on.</param>
    /// <returns>A new <see cref="Image"/>.</returns>
    public static Image UhdrloadStream(Stream stream, out Enums.ForeignFlags flags, int? shrink = null, bool? memory = null, Enums.Access? access = null, Enums.FailOn? failOn = null)
    {
        var source = SourceStream.NewFromStream(stream);
        var image = UhdrloadSource(source, out flags, shrink, memory, access, failOn);
    ...
    /// <example>
    /// <code language="lang-csharp">
    /// in.Uhdrsave(filename, q: int, keep: Enums.ForeignKeep, background: double[], pageHeight: int, profile: string);
    /// </code>
    /// </example>
    /// <param name="filename">Filename to save to.</param>
    /// <param name="q">Q factor.</param>
    ...
    /// <param name="pageHeight">Set page height for multipage save.</param>
    /// <param name="profile">Filename of ICC profile to embed.</param>
    public void Uhdrsave(string filename, int? q = null, Enums.ForeignKeep? keep = null, double[] background = null, int? pageHeight = null, string profile = null)
    {
        var options = new VOption();
        ...
        this.Call("uhdrsave", options, filename);
    }
    ...
    /// <example>
    /// <code language="lang-csharp">
    /// byte[] buffer = in.UhdrsaveBuffer(q: int, keep: Enums.ForeignKeep, background: double[], pageHeight: int, profile: string);
    /// </code>
    /// </example>
    /// <param name="q">Q factor.</param>
    /// <param name="keep">Which metadata to retain.</param>
    ...
    /// <param name="profile">Filename of ICC profile to embed.</param>
    /// <returns>An array of bytes.</returns>
    public byte[] UhdrsaveBuffer(int? q = null, Enums.ForeignKeep? keep = null, double[] background = null, int? pageHeight = null, string profile = null)
    {
        var options = new VOption();
        ...
        return this.Call("uhdrsave_buffer", options) as byte[];
    }
    ...
    /// <example>
    /// <code language="lang-csharp">
    /// in.UhdrsaveTarget(target, q: int, keep: Enums.ForeignKeep, background: double[], pageHeight: int, profile: string);
    /// </code>
    /// </example>
    /// <param name="target">Target to save to.</param>
    /// <param name="q">Q factor.</param>
    ...
    /// <param name="pageHeight">Set page height for multipage save.</param>
    /// <param name="profile">Filename of ICC profile to embed.</param>
    public void UhdrsaveTarget(Target target, int? q = null, Enums.ForeignKeep? keep = null, double[] background = null, int? pageHeight = null, string profile = null)
    {
        var options = new VOption();
        ...
        this.Call("uhdrsave_target", options, target);
    }
    ...
    /// <example>
    /// <code language="lang-csharp">
    /// in.UhdrsaveStream(stream, q: int, keep: Enums.ForeignKeep, background: double[], pageHeight: int, profile: string);
    /// </code>
    /// </example>
    /// <param name="stream">Stream to save to.</param>
    /// <param name="q">Q factor.</param>
    ...
    /// <param name="pageHeight">Set page height for multipage save.</param>
    /// <param name="profile">Filename of ICC profile to embed.</param>
    public void UhdrsaveStream(Stream stream, int? q = null, Enums.ForeignKeep? keep = null, double[] background = null, int? pageHeight = null, string profile = null)
    {
        using var target = TargetStream.NewFromStream(stream);
        UhdrsaveTarget(target, q, keep, background, pageHeight, profile);
    }
    ...
    /// <example>
    /// <code language="lang-csharp">
    /// in.Webpsave(filename, q: int, lossless: bool, exact: bool, preset: Enums.ForeignWebpPreset, smartSubsample: bool, nearLossless: bool, alphaQ: int, minSize: bool, kmin: int, kmax: int, effort: int, targetSize: int, mixed: bool, smartDeblock: bool, passes: int, keep: Enums.ForeignKeep, background: double[], pageHeight: int, profile: string);
    /// </code>
    /// </example>
    /// <param name="filename">Filename to save to.</param>
    /// <param name="q">Q factor.</param>
    /// <param name="lossless">Enable lossless compression.</param>
    /// <param name="exact">Preserve color values from transparent pixels.</param>
    ...
    /// <example>
    /// <code language="lang-csharp">
    /// byte[] buffer = in.WebpsaveBuffer(q: int, lossless: bool, exact: bool, preset: Enums.ForeignWebpPreset, smartSubsample: bool, nearLossless: bool, alphaQ: int, minSize: bool, kmin: int, kmax: int, effort: int, targetSize: int, mixed: bool, smartDeblock: bool, passes: int, keep: Enums.ForeignKeep, background: double[], pageHeight: int, profile: string);
    /// </code>
    /// </example>
    /// <param name="q">Q factor.</param>
    /// <param name="lossless">Enable lossless compression.</param>
    ...
    /// <example>
    /// <code language="lang-csharp">
    /// in.WebpsaveMime(q: int, lossless: bool, exact: bool, preset: Enums.ForeignWebpPreset, smartSubsample: bool, nearLossless: bool, alphaQ: int, minSize: bool, kmin: int, kmax: int, effort: int, targetSize: int, mixed: bool, smartDeblock: bool, passes: int, keep: Enums.ForeignKeep, background: double[], pageHeight: int, profile: string);
    /// </code>
    /// </example>
    /// <param name="q">Q factor.</param>
    /// <param name="lossless">Enable lossless compression.</param>
    ...
    /// <example>
    /// <code language="lang-csharp">
    /// in.WebpsaveTarget(target, q: int, lossless: bool, exact: bool, preset: Enums.ForeignWebpPreset, smartSubsample: bool, nearLossless: bool, alphaQ: int, minSize: bool, kmin: int, kmax: int, effort: int, targetSize: int, mixed: bool, smartDeblock: bool, passes: int, keep: Enums.ForeignKeep, background: double[], pageHeight: int, profile: string);
    /// </code>
    /// </example>
    /// <param name="target">Target to save to.</param>
    /// <param name="q">Q factor.</param>
    ...
    /// <example>
    /// <code language="lang-csharp">
    /// in.WebpsaveStream(stream, q: int, lossless: bool, exact: bool, preset: Enums.ForeignWebpPreset, smartSubsample: bool, nearLossless: bool, alphaQ: int, minSize: bool, kmin: int, kmax: int, effort: int, targetSize: int, mixed: bool, smartDeblock: bool, passes: int, keep: Enums.ForeignKeep, background: double[], pageHeight: int, profile: string);
    /// </code>
    /// </example>
    /// <param name="stream">Stream to save to.</param>
    /// <param name="q">Q factor.</param>
    ...
    {
        using var target = TargetStream.NewFromStream(stream);
        WebpsaveTarget(target, q, lossless, exact, preset, smartSubsample, nearLossless, alphaQ, minSize, kmin, kmax, effort, targetSize, mixed, smartDeblock, passes, keep, background, pageHeight, profile);
    }
    ...
    /// <example>
    /// <code language="lang-csharp">
    /// using Image @out = in.XYZ2Oklab();
    /// </code>
    /// </example>
    /// <returns>A new <see cref="Image"/>.</returns>
    public Image XYZ2Oklab()
    {
        return this.Call("XYZ2Oklab") as Image;
    }
